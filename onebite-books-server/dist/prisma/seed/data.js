...
exports.seedData = [
    {
        ...
        reviews: [
            {
                author: '김진수',
                content: '한 입 크기로 잘라 먹는 리액트는 초보자부터 전문가까지 모두에게 도움이 되는 훌륭한 교재입니다. 리액트의 핵심 개념과 실무에서 바로 적용할 수 있는 팁을 제공합니다.',
            },
            {
                author: '박영호',
                content: '이 책은 리액트를 처음 접하는 개발자들에게도 적합하며, 단계별로 따라 할 수 있는 예제들이 풍부하게 수록되어 있습니다.',
            },
            {
                author: '최미나',
                content: '리액트의 고급 기능까지 다루고 있어 초보자뿐만 아니라 중급 이상의 개발자들도 깊이 있는 학습을 할 수 있습니다.',
            },
            {
                author: '코딩천재',
                content: '리액트의 핵심 개념을 파악하는 데 이 책만큼 좋은 교재는 없을 것입니다.',
            },
            {
                author: '개발하는민수',
    ...
    },
    {
        ...
        reviews: [
            {
                author: '이진아',
                content: '자바스크립트 첫걸음은 자바스크립트를 처음 시작하는 사람에게 꼭 필요한 책입니다. 문법부터 고급 개념까지 체계적으로 배울 수 있습니다.',
            },
            {
                author: '윤세진',
            ...
            {
                author: '김수현',
                content: '기초부터 고급까지 다양하게 다루고 있어 여러 개발자에게 유용합니다.',
            },
            {
                author: '코딩스타',
    ...
    },
    {
        ...
        coverImgUrl: 'https://shopping-phinf.pstatic.net/main_3647026/36470265624.20230110165934.jpg',
        author: '조현영',
        publisher: '길벗',
        ...
        reviews: [
            {
                author: '이상훈',
                content: 'Node.js 교과서는 Node.js의 핵심 개념을 파악하는 데 도움이 됩니다.',
            },
            {
                author: '프론트신동',
    ...
    },
    {
        ...
        reviews: [
            {
                author: '이정민',
                content: '이펙티브 타입스크립트는 타입스크립트의 고급 기능을 쉽게 익히기에 좋은 책입니다.',
            },
            {
                author: '프로그래밍매니아',
    ...
    },
    {
        ...
        subTitle: '인텔리제이, JPA, JUnit 테스트, 그레이들, 소셜 로그인, AWS 인프라로 무중단 배포까지',
        coverImgUrl: 'https://shopping-phinf.pstatic.net/main_3243625/32436253723.20230928091945.jpg',
        author: '이동욱(향로)',
        publisher: '프리렉',
        ...
        reviews: [
            {
                author: '이서윤',
                content: '스프링 부트와 AWS로 혼자 구현하는 웹 서비스는 실무 적용을 위한 정보가 많습니다.',
            },
            {
                author: '코딩왕',
    ...
    },
    {
        ...
        coverImgUrl: 'https://shopping-phinf.pstatic.net/main_3243600/32436007738.20221229072907.jpg',
        author: '김영한',
        publisher: '에이콘출판',
        ...
        reviews: [
            {
                author: '김서윤',
                content: '자바 ORM 표준 JPA 프로그래밍은 JPA의 기초부터 고급 기능까지 다룹니다.',
            },
            {
                author: '박영준',
                content: 'JPA를 활용해 다양한 상황에서 데이터베이스를 효율적으로 관리할 수 있습니다.',
            },
            {
                author: 'JPA왕',
    ...
    },
    {
        ...
        coverImgUrl: 'https://shopping-phinf.pstatic.net/main_3245323/32453230352.20230627102640.jpg',
        author: '조영호',
        publisher: '위키북스',
        ...
        reviews: [
            {
                author: '박지은',
                content: '오브젝트는 객체 지향 프로그래밍의 기본 원리를 이해하는 데 도움이 됩니다.',
            },
            {
                author: '프로그래밍신동',
                content: '객체 지향 프로그래밍의 설계 원리를 배우는 데 훌륭한 가이드입니다.',
            },
            {
                author: '이현정',
                content: '다양한 예제와 함께 객체 지향 프로그래밍의 핵심을 배울 수 있습니다.',
            },
            {
                author: '객체마스터',
